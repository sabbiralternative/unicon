    ...
    <div className="flex flex-col transition-all">
      <div className="flex items-start flex-col lg:flex-row justify-start w-full lg:px-12 xl:px-20 xlg:px-24">
        ...
        <div className="w-full h-full  lg:w-[54%] lg:pt-2">
          <div className="hidden lg:flex sticky top-0  app-bg font-lato-bold w-full flex-col gap-y-1.5 lg:pt-0">
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <a
                      className="ml-1 text-base transition-all ease-in-out duration-300 hover:underline text-black font-semibold"
                      aria-current="page"
                    >
                      Promotions
                    </a>
