                ...
                {settings.cashout &&
                  ...
                  !speedCashOut && (
                    <button
                      ...
                      type="button"
                      className={`inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out  rounded-md px-2.5 py-1.5 text-center shadow-[inset_-12px_-8px_40px_#46464620] flex items-center justify-center ${teamProfitForGame?.profit?.toString()?.length > 2 ? "flex-col" : "flex-row"} h-max max-w-[74%] mr-1 cursor-pointer ${
